...
import 'package:u_wifi/functions/tokens.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.loggedIn ? const NavBarPage() : const LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn ? const NavBarPage() : const LoginPageWidget(),
        ),
        FFRoute(
          name: 'Welcome',
          path: '/welcome',
        ...
        FFRoute(
          ...
          builder: (context, params) {
            //TODO: handle current user and route security
            final String? token = params.getParam('token', ParamType.String);
            if (token == null) return const LoginPageWidget();
            final payload = parseJwt(token);
            if (payload == null) return const LoginPageWidget();
            return PasswordRecoveryCopyWidget(token: token, payload: payload);
          },
        ),
        FFRoute(
          name: 'merch_page',
        ...
        FFRoute(
          ...
          path: '/adsHomePage',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'Ads_Home_page') : const AdsHomePageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/profileNew',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'ProfileNew') : const ProfileNewWidget(),
        ),
        FFRoute(
          name: 'ScrollVideos',
          path: '/scrollVideos',
        ...
        FFRoute(
          ...
          path: '/newHome',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'NewHome') : const NewHomeWidget(),
        ),
        FFRoute(
          name: 'NewWallet',
          path: '/newWallet',
